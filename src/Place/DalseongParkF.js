...
export default function DalseongParkF({ uid }) { 
    ...
    return (
        <dir className='DalseongParkF'>
            ...
            <h1 className='place'>달성공원</h1>

            <img className='PlacePhoto' src="test1.jpg"></img>

            <h4 className='장소설명'>
            &#62; 위치: 대구광역시 중구 달성공원로 35 달성공원 <br/>
            &#62; 공원 부지 전체가 사적지로 지정된 달성&#40;達城&#41;이고 안에는 달성공원 동물원, 향토역사관이 있다. 달성공원은 
            도시근린공원으로 희귀 수목과 조경수로 꾸며져 있다. 대구 도심 중심부에 있어 교통이 편리하다.
            </h4>
